    ...
    def __init__(self, config=None):
        ...
        if self.config.fz:
            ...
            for key, param in self.backbone4.named_parameters():
                param.requires_grad = False
        outdim = 1
        self.backbone1.fc = nn.Linear(512, outdim)
        self.backbone2.fc = nn.Linear(512, outdim)
        self.backbone3.fc = nn.Linear(512, outdim)
        self.backbone4.fc = nn.Linear(512, outdim)
